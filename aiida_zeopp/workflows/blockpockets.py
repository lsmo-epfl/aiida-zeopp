...
class ZeoppBlockPocketsWorkChain(WorkChain):
    ...
    def define(cls, spec):
        ...
        spec.input("_num_samples", valid_type=dict, required=False, default=num_samples_default)
        ...
        spec.output("surface_area_sa", valid_type=ParameterData, required=False)
        spec.output("free_sphere_res", valid_type=ParameterData, required=False)
    ...
    def should_run_block_zeopp(self):
        ...
        return self.ctx.zeopp_geometry["pore_volume_volpo"].dict.PONAV_Volume_fraction  > 0.001
    ...
    def return_result(self):
        ...
        try:
			...
			pass
        self.out("pore_volume_volpo", self.ctx.zeopp_geometry["pore_volume_volpo"])
